...
var uploadedFiles = [];  // Track uploaded documents
    ...
    async function sendMessage() {
        ...
        try {
            var headers = { "Content-Type": "application/json" };
            if (authToken) headers["Authorization"] = "Bearer " + authToken;
            var agMode = "auto"; // Agent auto-decides strategy based on user input
            var chatBody = { message: text, user_input: text, conversation_id: conversationId, device_id: deviceId, mode: agMode };
...
// ====== 文档列表管理 (merged from doc-manager.js) ======
